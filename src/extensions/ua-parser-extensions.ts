...
const normalizeEmailName = function (str: string) {
...
export const ExtraDevices = Object.freeze({
    device : [[
...
export const Fetchers = Object.freeze({
    ...
    os : [
        [/whatsapp\/[\d\.]+ (a|i)/i],
        [[NAME, (os: string) => os === 'A' ? 'Android' : 'iOS' ]]
    ]
});
...
export const InApps = Object.freeze({
    browser : [[
...
export const MediaPlayers = Object.freeze({
    browser : [[
